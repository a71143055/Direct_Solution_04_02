package kr.ac.kopo.direct_solution_04_02;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text3.setText("Single Line 속성 Single Line 속성 Single Line 속성");
    ...
    View.OnClickListener btnListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            String university = edit1.getText().toString();
            String result = university + "에 합격하신 것을 진심으로 축하드립니다.";
